...
<html>
	<head>
		<title>
			<s:if test="fatherId == null">Add</s:if><s:else>Edit</s:else> Father
		</title>
	</head>
	<body>
		<s:form id="fatherRecordForm" action="fatherRecord!save" namespace="/agent/ajax" theme="xhtml" method="post" enctype="multipart/form-data" data-ajax="false">
			<s:hidden name="fatherId" />
		...
		<sjm:a button="true" buttonIcon="gear" formIds="fatherRecordForm" dataTheme="a">Save</sjm:a>

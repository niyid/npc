...
<s:if test="hasActionErrors()">
	<div class="error" id="errorMessages"><s:iterator value="actionErrors">
		<img src="<c:url value="/img/warning.gif"/>" alt="<fmt:message key="icon.warning"/>" class="icon" />
		<s:property />
		<br />
	</s:iterator></div>
</s:if>
...
<s:if test="hasActionMessages()">
	<div class="error" id="actionMessages"><s:iterator value="actionMessages">
		<img src="<c:url value="/img/check.gif"/>" alt="<fmt:message key="icon.message"/>" class="icon" />
		<s:property />
		<br />
	</s:iterator></div>
</s:if>
...
<c:if test="${not empty messages}">
	<div class="message" id="successMessages"><c:forEach var="msg" items="${messages}">
		<img src="<c:url value="/img/check.gif"/>" alt="<fmt:message key="icon.information"/>" class="icon" />
		<c:out value="${msg}" />
		<br />
	</c:forEach></div>

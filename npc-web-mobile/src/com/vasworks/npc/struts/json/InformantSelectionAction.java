...
public class InformantSelectionAction extends AgentAction {
	...
	private static final Log LOG = LogFactory.getLog(InformantSelectionAction.class);
	...
	public String execute() {
		String jsonString = agentService.autocompleteInformants(param);

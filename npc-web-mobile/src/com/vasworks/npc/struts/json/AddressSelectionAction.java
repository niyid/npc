...
public class AddressSelectionAction extends AgentAction {
	...
	private static final Log LOG = LogFactory.getLog(AddressSelectionAction.class);
	...
	public String execute() {
		String jsonString = agentService.autocompleteAddresses(param);

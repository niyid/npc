...
public class EthnicitySelectionAction extends AgentAction {
	...
	private static final Log LOG = LogFactory.getLog(EthnicitySelectionAction.class);
	...
	public String execute() {
		String jsonString = agentService.autocompleteEthnicities(param);
